...
import com.icarasia.social.socialmediaapp.postsFragment.DI.DaggerPostFragmetComponent
import com.icarasia.social.socialmediaapp.postsFragment.DI.PostFragmetModule
...
class  PostsFragment : SocialMediaNetworkFragment(R.id.drawer_layout) , PostViewContract {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        DaggerPostFragmetComponent
                .builder()
                .appComponent(networkActivity.application.App.appComponent)
    ...
    override fun toCommentsActivity(post: Post) {
        startActivity(
                with(Intent(this@PostsFragment.context, CommentsActivity::class.java)) {
